...
const appActionsType = {
    ...
    //重置资源数据列表和资源详情Action名称
    RESET_RESOURCE_LIST_VIEW_LIST_DETAIL: "RESET_RESOURCE_LIST_VIEW_LIST_DETAIL",
    //获取资源详情用户头像Action名称
    GET_USER_HEAD_PORTRAIT_VIEW_DETAIL: "GET_USER_HEAD_PORTRAIT_VIEW_DETAIL",
    //改变"评论"富文本编辑器编辑框内容Action名称
    CHANGE_RESOURCES_LIST_VIEW_DETAILS_COMMENT: "CHANGE_RESOURCES_LIST_VIEW_DETAILS_COMMENT",
    //获取资源详情评论列表Action名称
    GET_RESOURCES_LIST_VIEW_DETAILS_COMMENT_LIST: "GET_RESOURCES_LIST_VIEW_DETAILS_COMMENT_LIST",
    //改变"评论"富文本编辑器编辑框内容Action名称
    CHANGE_PERSONAL_RESOURCES_LIST_VIEW_DETAILS_COMMENT: "CHANGE_PERSONAL_RESOURCES_LIST_VIEW_DETAILS_COMMENT",
    //改变匹配资源"评论"富文本编辑器编辑框内容Action名称
    CHANGE_PERSONAL_MATCHED_RESOURCES_LIST_VIEW_DETAILS_COMMENT: "CHANGE_PERSONAL_MATCHED_RESOURCES_LIST_VIEW_DETAILS_COMMENT",
    //获取个人资源详情评论列表Action
    GET_PERSONAL_RESOURCES_LIST_VIEW_DETAILS_COMMENT_LIST: "GET_PERSONAL_RESOURCES_LIST_VIEW_DETAILS_COMMENT_LIST",
    //改变资源列表分页页码Action名称
    CHANGE_RESOURCES_LIST_PAGINATION_CURRENT: "CHANGE_RESOURCES_LIST_PAGINATION_CURRENT",
    //改变个人资源分页页码Action名称
    CHANGE_PERSONAL_RESOURCES_LIST_PAGINATION_CURRENT: "CHANGE_PERSONAL_RESOURCES_LIST_PAGINATION_CURRENT",
    //改变个人匹配资源分页页码Action名称
    CHANGE_PERSONAL_RESOURCES_LIST_VIEW_MATCHED_PAGINATION_CURRENT: "CHANGE_PERSONAL_RESOURCES_LIST_VIEW_MATCHED_PAGINATION_CURRENT",
    //获取资源列表滚动条初始距离顶部高度Action名称
    GET_RESOURCES_LIST_PAGINATION_BEFORE_OS_TOP: "GET_RESOURCES_LIST_PAGINATION_BEFORE_OS_TOP",
    //获取个人资源列表滚动条初始距离顶部高度Action名称
    GET_PERSONAL_RESOURCES_LIST_PAGINATION_BEFORE_OS_TOP: "GET_PERSONAL_RESOURCES_LIST_PAGINATION_BEFORE_OS_TOP",
    //获取个人匹配资源列表滚动条初始距离顶部高度Action名称
    GET_PERSONAL_RESOURCES_LIST_VIEW_MATCHED_PAGINATION_BEFORE_OS_TOP: "GET_PERSONAL_RESOURCES_LIST_VIEW_MATCHED_PAGINATION_BEFORE_OS_TOP",
    //重置对话框状态Action名称
